/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: c658f2db821c5713879247020fd555ac)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UI_HOST" | "API_HOST" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GOOGLE_GENERATIVE_AI_API_KEY" | "OPENAI_API_KEY" | "ANTHROPIC_API_KEY">> {}
}
declare module "*.sql" {
	const value: string;
