/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 2ddc0ac5d78f31820a0a26171a1777d5)
// Runtime types generated with workerd@1.20250508.0 2025-05-11 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GOOGLE_GENERATIVE_AI_API_KEY" | "OPENAI_API_KEY" | "ANTHROPIC_API_KEY">> {}
}
declare module "*.sql" {
	const value: string;
